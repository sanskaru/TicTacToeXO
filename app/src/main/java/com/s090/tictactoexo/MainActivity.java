...
public class MainActivity extends AppCompatActivity {
    ...
    public void congrats(String msg) // method to call dialog box
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
        builder.setTitle("Congratulations!").setMessage(msg).setCancelable(false);
    ...
    public void drop_in(View view)
    {
        ...
        if (boardState[cellState]==-1) {
            ...
            if(boardState[0]==boardState[1] && boardState[1]==boardState[2] && boardState[0]!=-1) {
                ...
                congrats("Player "+boardState[0]+" has won.");
            }
